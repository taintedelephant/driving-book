        ...
        <nav className="flex justify-between items-center py-4">
          ...
          <div className="flex items-end">
            <Link href="/" className="flex items-end">
              ...
              <span className="bg-primary text-white text-xs px-1 py-0.5 ml-1 rounded-sm">School</span>
            </Link>
          ...
          <div className="hidden md:flex space-x-2">
            ...
            <Link href="/become-instructor">
              <a className={`px-3 py-2 rounded text-sm font-medium transition ${location === '/become-instructor' ? 'bg-gray-100' : 'hover:bg-gray-100'}`}>
        ...
        <div className="md:hidden bg-white border-t border-gray-200 py-2">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col space-y-1">
              ...
              <Link href="/become-instructor">
                <a 
                  className={`px-3 py-2 rounded text-sm font-medium transition ${location === '/become-instructor' ? 'bg-gray-100' : 'hover:bg-gray-100'}`}
                  onClick={closeMenu}
                >
                  Become an Instructor
                </a>
