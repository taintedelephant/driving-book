...
import { add, format, startOfDay, endOfDay, isWithinInterval, parseISO } from "date-fns";
...
export interface IStorage {
  ...
  updateBookingPaymentStatus(id: number, hasPaid: boolean): Promise<Booking | undefined>;
...
export class MemStorage implements IStorage {
    ...
    const testimonials = [
      {
        ...
        date: "September 2023",
        rating: 5,
        content: "I was extremely nervous about learning to drive, but my instructor was so patient and encouraging. I passed my test first time and couldn't be happier with the service!"
      },
      {
        name: "James Wilson",
        date: "August 2023",
        rating: 5,
        content: "The intensive course was perfect for me. My instructor made sure I was fully prepared for my test in just two weeks. Professional service from start to finish."
      },
      {
        name: "Emily Chen",
        date: "July 2023",
        rating: 4.5,
        content: "After trying another driving school without success, I switched to Calm Driving. The difference was incredible - clear explanations, structured lessons, and a relaxed atmosphere."
      }
    ];
  ...
  async createBooking(booking: InsertBooking): Promise<Booking> {
    ...
    const matchingSlots = Array.from(this.timeSlots.values()).filter(slot => 
  ...
  async updateBookingPaymentStatus(id: number, hasPaid: boolean): Promise<Booking | undefined> {
